                                  ...
                                  Positioned(
                                    ...
                                    child: CartItemAmount(
                                      ...
                                      onPlusIconTap:
                                          ...
                                          CartProvider.of(
                                            context,
                                          ).increaseCartItemAmount(index),
                                      onMinusIconTap:
                                          () =>
                                          CartProvider.of(
                                            context,
                                          ).decreaseCartItemAmount(index),
                                    ),
                                  ),
                                ],
                              ),
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                if (CartProvider
                  ...
                  if (result == '확인') {
                    String searchQuery = cartItems.sublist(0, min(3, cartItems.length))
                        .map((cartItem) => '${cartItem.product.category.label}%20용품').join('%20');
                    final url = Uri.parse(
